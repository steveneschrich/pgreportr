test_that("Investigator formatting works", {
  expect_equal(format_investigator_name("John Jay Smith, PhD"), "JJ. Smith, PhD")
  expect_equal(format_investigator_name("John Jay Smith, PhD, MD"), "JJ. Smith, PhD, MD")
  expect_equal(format_investigator_name("Smith, PhD"), "Smith, PhD")
  expect_equal(format_investigator_name("John Jay Smith, PhD", use_degree = FALSE), "JJ. Smith")
  expect_equal(format_investigator_name("John Jay Smith, PhD, MD", use_degree = FALSE), "JJ. Smith")
  expect_equal(format_investigator_name("Smith, PhD", use_degree = FALSE), "Smith")

  name_list<-c("John Jay Smith", "Smith","John Smith")
  expect_equal(format_investigator_name(name_list,
