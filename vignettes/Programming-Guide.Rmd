...
# grants tibble
The main interface to activities within u54reportr is the tibble containing the grant information. This is created by `import-redcap-data()`, which loads REDCap data (obviously) and performs a variety of actions, including:
